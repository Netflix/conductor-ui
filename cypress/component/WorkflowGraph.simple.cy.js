...
import { dagSimpleSuccess, dagSimpleUnexecuted, dagSimpleFailure, dagSimpleRetries, dagSimpleDefOnly } from "../../src/utils/test/dagSimple";
...
describe('Simple Task', () => {
  describe("Success", () => {
    ...
    it("is COMPLETED and colored green", () => {
      ...
      cy.get("#simple_task rect").should('have.css', "fill", 'rgb(174, 225, 184)');
    });
    ...
    it("handles click", () => {
      ...
      cy.get('@onClickSpy').should('have.been.calledWith', { ref: "simple_task" });;
    });
    ...
    it("displays selection", () => {
      cy.mount(<WorkflowGraph dag={dag} executionMode={true} selectedTask={{ ref: "simple_task" }} />);
