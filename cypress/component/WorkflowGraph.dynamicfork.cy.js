...
import { dagDynamicForkSuccess, dagDynamicForkFailure, dagDynamicForkRetries, dagDynamicForkUnexecuted, dagDynamicForkNoneSpawned, dagDynamicForkDefOnly } from "../../src/utils/test/dagDynamicFork";
...
describe('Dynamic Fork', () => {
  describe("Definition Only", () => {
    ...
    it("Spawned task placeholder is a stack of cards and has no color", () => {
      ...
      cy.get("#dynamic_fork_DF_CHILDREN_PLACEHOLDER").should('have.class', "type-DF_CHILDREN_PLACEHOLDER");
      cy.get("#dynamic_fork_DF_CHILDREN_PLACEHOLDER").should('not.have.class', "status_COMPLETED");
    });
    ...
    it("Spawned task placeholder has placeholder text", () => {
      ...
      cy.get("#dynamic_fork_DF_CHILDREN_PLACEHOLDER").should('contain.text', "Dynamically spawned tasks");
    });
    ...
    it("Click on top bar selects FORK_JOIN_DYNAMIC", () => {
      ...
      cy.get('@onClickSpy').should('have.been.calledWith', { ref: "dynamic_fork" });;
    });
    ...
    it("Click on bottom bar selects JOIN", () => {
      ...
      cy.get('@onClickSpy').should('have.been.calledWith', { ref: "dynamic_fork_join" });;
    });
  ...
  describe("Unexecuted", () => {
    ...
    it("Spawned task placeholder is a stack of cards and is dimmed", () => {
      cy.mount(<WorkflowGraph dag={dag} executionMode={true} />);
      cy.get("#dynamic_fork_DF_CHILDREN_PLACEHOLDER").should('have.class', "type-DF_CHILDREN_PLACEHOLDER");
      cy.get("#dynamic_fork_DF_CHILDREN_PLACEHOLDER").should('have.class', "dimmed");
    });
  ...
  describe("None Spawned", () => {
    ...
    it("Placeholder is a stack of cards and COMPLETED", () => {
      cy.mount(<WorkflowGraph dag={dag} executionMode={true} />);
      cy.get("#dynamic_fork_DF_CHILDREN_PLACEHOLDER").should('have.class', "type-DF_CHILDREN_PLACEHOLDER");
      cy.get("#dynamic_fork_DF_CHILDREN_PLACEHOLDER").should('have.class', "status_COMPLETED");
    });

    it("Spawned task placeholder has placeholder text", () => {
      cy.mount(<WorkflowGraph dag={dag} executionMode={false} />);
      cy.get("#dynamic_fork_DF_CHILDREN_PLACEHOLDER").should('contain.text', "No tasks spawned");
    });
  ...
  describe("High fanout - Success", () => {
    ...
    it("Placeholder has correct count of succeeded tasks", () => {
      cy.mount(<WorkflowGraph dag={dag} executionMode={true} />);
      cy.get("#dynamic_fork_DF_CHILDREN_PLACEHOLDER").should('contain.text', "5 of 5 tasks succeeded");
    });
    ...
    it("JOIN bar contains ref and name in parentheses", () => {
      ...
      cy.get("#dynamic_fork_join").should('contain.text', "(dynamic_fork_join_name)");
    });
    ...
    it("Click on placeholder selects first child", () => {
      ...
      cy.get("#dynamic_fork_DF_CHILDREN_PLACEHOLDER > .label-container").click();
      cy.get('@onClickSpy').should('have.been.calledWith', { ref: "dynamic_fork_child_0" });;
    });
  ...
  describe("High fanout - Failure", () => {
    ...
    it("Placeholder is a stack of cards and FAILED", () => {
      cy.mount(<WorkflowGraph dag={dag} executionMode={true} />);
      cy.get("#dynamic_fork_DF_CHILDREN_PLACEHOLDER").should('have.class', "type-DF_CHILDREN_PLACEHOLDER");
      cy.get("#dynamic_fork_DF_CHILDREN_PLACEHOLDER").should('have.class', "status_FAILED");
    });

    it("Placeholder has correct count of succeeded tasks", () => {
      cy.mount(<WorkflowGraph dag={dag} executionMode={true} />);
      cy.get("#dynamic_fork_DF_CHILDREN_PLACEHOLDER").should('contain.text', "4 of 5 tasks succeeded");
    });
  ...
  describe("Low fanout - Success", () => {
    ...
    it("Children has ref and name labels", () => {
      cy.mount(<WorkflowGraph dag={dag} executionMode={true} />);
      cy.get("#dynamic_fork_child_0").should('contain.text', "dynamic_fork_child_0");
      cy.get("#dynamic_fork_child_1").should('contain.text', "(dynamic_fork_child)");
    });
  ...
  describe("Low Fanout - Retries", () => {
    ...
    it("Click on retried child is handled", () => {
      ...
      cy.get('@onClickSpy').should('have.been.calledWith', { ref: "dynamic_fork_child_1" });;
    });
  });
});
